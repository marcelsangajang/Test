...
{{ Form::open(array('url' => '/postPeriod')) }}
    ...
    {{ Form::label('', 'Breaks') }}
    {{ Form::select('break1_start_mo', ['11:00:00', '12:00:00', '13:00:00'], 1) }} 
    to 
    {{ Form::select('break1_end_mo', ['11:00:00', '12:30:00', '13:30:00'], 1) }} 
    
    <br>
    {{ Form::label('end_time_mo', 'End time') }}
    {{ Form::number('end_time_mo', 'End time') }}
    {{ Form::label('', 'Breaks') }}
    {{ Form::select('break2_start_mo', [14, 15, 16], 1) }}
    to
    {{ Form::select('break2_end_mo', [14.30, 15.30, 16.30], 1) }}
    <br>
